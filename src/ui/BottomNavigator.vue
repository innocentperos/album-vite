<template>
  <IconButton xlarge v-if="fab" :loading="fabLoading" @click="fabClick" class="fixed mb-3 bottom-16 md:bottom-3 right-0 mr-3 z-10 aspect-square shadow-xl rounded-[50%] flex">
